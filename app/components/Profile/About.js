    ...
    return (
      ...
      >
        ...
        <Grid item md={5} xs={12}>
          ...
          {/* ----------------------------------------------------------------------*/}
          {/* About Me */}
          <PaperBlock title="About Me" icon="ios-contact-outline" whiteBg noMargin desc="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse sed urna in justo euismod condimentum.">
          ...
          {/* ----------------------------------------------------------------------*/}
          {/* My Albums */}
          <PaperBlock title="My Albums (6)" icon="ios-images-outline" whiteBg desc="">
          ...
          {/* ----------------------------------------------------------------------*/}
          {/* My Connection Me */}
          <PaperBlock title="My Connection" icon="ios-contacts-outline" whiteBg desc="">
            <List dense className={classes.profileList}>
              <ListItem button>
          ...
          {/* ----------------------------------------------------------------------*/}
          {/* My Interests */}
          <PaperBlock title="My Interests" icon="ios-aperture-outline" whiteBg desc="">
