...
class UpdateProfileInterestForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      openSnackBar: false,
  ...
  onDropRejected() {
	...
	render() {
	  const {
	    classes, closeForm, name, sex, inputChange,
	  } = this.props;
...
UpdateProfileInterestForm.propTypes = {
...
export default withStyles(styles)(UpdateProfileInterestForm);
