...
class InvalidToken extends React.Component {
  render() {
    const title = brand.name + ' - InvalidToken';
    ...
    return (
      <div className={classes.root}>
        ...
        <div className={classes.container}>
          ...
          <Typography variant="h4" className={classes.title} gutterBottom>Invalid or Expired Token </Typography>
...
export default withStyles(styles)(InvalidToken);
