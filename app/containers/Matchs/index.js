...
import styles from './jss/matchs-jss';
...
class Matchs extends PureComponent {
...
const MatchsMapped = connect(
	mapStateToProps,
	constDispatchToProps
)(Matchs);

export default withStyles(styles)(MatchsMapped);
